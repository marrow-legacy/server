# encoding: utf-8
#
# Marrow.server documentation build configuration file.
#
...
html_title = "Marrow Server %s Documentation" % (version, )
...
htmlhelp_basename = 'MarrowServer-Doc'
...
latex_documents = [
  ('index', 'MarrowServer.tex', u'Marrow Server API Documentation', u'Alice Bevan-McGregor', 'manual'),
]
